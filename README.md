...
*   **レスポンシブ & モバイル対応**:
    *   PC/横画面: 3カラムレイアウトで情報を一覧表示。
    *   スマホ/縦画面: 縦積みレイアウトに自動切り替え。設定画面も操作しやすいビッグサイズ仕様。
*   **ダイナミックな演出**:
    *   **左バナー**: 「アイアンドディー」「忘年会ビンゴ大会」が交互に巨大な文字でアニメーション表示。
    *   **ファンファーレ**: 当選決定時に効果音が鳴り、会場を盛り上げます。
    *   **紙吹雪**: 当選時に画面いっぱいに紙吹雪が舞います。
*   **3カラムレイアウト (PC時)**:
    *   **左**: アニメーションバナーエリア。
    *   **中央**: メイン抽選エリア - 巨大な数字表示。
    *   **右**: 当選履歴 - 過去の当選番号を縦並びで大きく表示。
